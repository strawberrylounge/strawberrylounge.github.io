$(document).ready(function () {
  /* SELECTBOX */
  $(".selectbox-wrap, .footer-selectbox-wrap").click(function (e) {
  ...
  $(".selectbox-option, .footer-selectbox-option").click(function () {
...
function goBack() {
    if (window.history.length > 1) {
        ...
        window.location.href = '/online/main.prn'; // 메인 페이지로
    }
}